export function CTASection() {
  return (
    <section className="py-16 sm:py-24" style={{ background: '#f8faff' }}>
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                ...
                style={{ background: 'white', color: '#7494ec' }}
              >
                Dùng thử miễn phí 14 ngày
              </button>
              <button 
                className="px-8 py-4 rounded-xl font-semibold text-lg text-white transition-all hover:bg-white/20"
